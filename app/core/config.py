...
class TelegramSettings(BaseSettings):
    model_config = _env_config("MODERATOR_BOT_")

    token: str = Field(..., description="Moderator bot token from BotFather")


class AdminSettings(BaseSettings):
    model_config = _env_config("ADMIN_")
...
class OpenRouterSettings(BaseSettings):
    model_config = _env_config("OPENROUTER_")
...
class AssistantSettings(BaseSettings):
    model_config = _env_config("ASSISTANT_BOT_")
...
class TelethonSettings(BaseSettings):
    model_config = _env_config("TELETHON_")

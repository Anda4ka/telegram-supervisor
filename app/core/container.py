...
class Container:
    ...
    def __init__(self) -> None:
        ...
        self._channel_orchestrator: ChannelOrchestrator | None = None
    ...
    def set_channel_orchestrator(self, orchestrator: ChannelOrchestrator) -> None:
        """Set channel orchestrator instance."""
        self._channel_orchestrator = orchestrator

    def get_channel_orchestrator(self) -> ChannelOrchestrator | None:
        """Get channel orchestrator instance (None if not configured)."""
        return self._channel_orchestrator

    def set_analytics_collector(self, collector: AnalyticsCollector) -> None:
        """Set analytics collector instance."""
        self._analytics_collector = collector

    def get_analytics_collector(self) -> AnalyticsCollector | None:
        """Get analytics collector instance (None if not started)."""
